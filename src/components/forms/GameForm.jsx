...
export function GameForm({ platforms, onSubmit, onCancel }) {
  ...
  return <>
    <Formik 
      initialValues={{ title: '', slug: '', price: '', discount: 0, releaseDate: '', summary: '', video: '', cover: '', wallpaper: '', screenshots: '', platformId: platforms[0]?.id || '' }} 
      onSubmit={onSubmit}>
        <Form>
          <FormGrid>
          ...
          <ModalActions>
            ...
            <HeaderAction type="submit">Guardar juego</HeaderAction>
          </ModalActions>
        </Form>
      </Formik>
  </>
